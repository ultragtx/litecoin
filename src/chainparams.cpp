...
public:
    CMainParams() {
        ...
        // TO-DO: Update consensus.BIP16Height = 218579; // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 840000;
        // TO-DO: Update consensus.BIP16Height = 0; // always enforce P2SH BIP16 on regtest
